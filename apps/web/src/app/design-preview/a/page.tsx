...
const C = {
  ...
  blue: "#2563EB",
  cyan: "#06B6D4",
  glow: "0 0 20px rgba(124,58,237,.35), 0 0 40px rgba(6,182,212,.15)",
  glowCyan: "0 0 12px rgba(6,182,212,.5)",
} as const;
...
@keyframes pulse-glow {
  ...
  50%      { box-shadow: 0 0 20px rgba(6,182,212,.55); }
}
@keyframes aurora {
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(124,58,237,.12) 0%, rgba(6,182,212,.06) 50%, transparent 70%)",
            pointerEvents: "none",
            filter: "blur(80px)",
          }}
        />
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(37,99,235,.1) 0%, rgba(124,58,237,.05) 50%, transparent 70%)",
            pointerEvents: "none",
            filter: "blur(100px)",
          }}
        />
        ...
        >
          ...
          >
            ...
            >
              Midnight Aurora &mdash; Design Preview A
            </p>
          </header>
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          alignItems: "center",
                          gap: 14,
                          borderLeft: `2px solid ${project.color}44`,
                          transition: "all .25s ease",
                          cursor: "default",
                          ...stagger(pi + 2 + ti * 0.6),
                        }}
          ...
          <div style={{ marginTop: 28, ...stagger(6) }}>
            ...
            >
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLElement).style.boxShadow =
                    "0 0 30px rgba(124,58,237,.5), 0 0 60px rgba(6,182,212,.25)";
          ...
          >
            Design Candidate A &middot; Midnight Aurora &middot; Static Preview
          </footer>
        </div>
      </div>
    </>
