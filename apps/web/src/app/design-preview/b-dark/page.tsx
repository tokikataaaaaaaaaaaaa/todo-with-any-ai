...
// =============================================================================
// Design B-Dark: "Paper & Ink" Dark Mode - Static Demo Page
// =============================================================================

// -- Color Tokens (Dark Mode) -------------------------------------------------
const colors = {
  bg: "#0F0E0C", // dark sumi
  cardBg: "#1A1816", // dark washi
  border: "#2A2622",
  primary: "#E8E4DE", // washi text
  accent: "#E05A50", // bright shu (vermillion)
  green: "#4A9668", // bright matcha
  textPrimary: "#E8E4DE",
...
// -- Project color palette (Japanese-style, dark-adjusted) --------------------
const projectColors = {
  shu: "#E05A50",
  matcha: "#4A9668",
  ai: "#4B8BC2",
...
function PriorityBadge({ level }: { level: "high" | "medium" | "low" }) {
  const config = {
    high: { label: "High", bg: "#E05A50", fg: "#fff" },
    medium: { label: "Med", bg: "#E8B830", fg: "#0F0E0C" },
    low: { label: "Low", bg: "#2A2622", fg: "#8A8580" },
  };
  ...
  return (
    <div
      ...
      style={{
        ...
        background: hovered ? "#221F1C" : "transparent",
      }}
    >
      {/* Checkbox circle */}
      <span
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: 4,
        cursor: "pointer",
        background: active ? "#2A2622" : hovered ? "#221F1C" : "transparent",
        transition: "background 0.15s",
        fontFamily: "'Noto Sans JP', sans-serif",
        fontSize: 14,
  ...
  return (
    <span
      ...
      style={{
        ...
        background: hovered ? "rgba(74, 150, 104, 0.1)" : colors.cardBg,
        fontSize: 13,
        color: colors.green,
        cursor: "pointer",
...
// Main Page
// =============================================================================
export default function DesignBDarkPage() {
  return (
    <>
      {/* Google Fonts */}
      ...
      {/* Washi texture overlay via CSS noise (dark version) */}
      <style>{`
        .washi-bg-dark {
          position: relative;
        }
        .washi-bg-dark::before {
          content: '';
          position: fixed;
          inset: 0;
          pointer-events: none;
        ...
        /* Sumi stroke decorative divider (dark version) */
        .sumi-divider-dark {
          height: 2px;
          background: linear-gradient(90deg, transparent 0%, #E8E4DE 20%, #E8E4DE 80%, transparent 100%);
          opacity: 0.06;
          margin: 0 auto;
        }
      `}</style>
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            {/* Logo mark: a small sumi circle (inverted for dark) */}
            <div
              style={{
                width: 28,
                height: 28,
        ...
        <div style={{ display: "flex", minHeight: "calc(100vh - 65px)" }}>
          ...
          >
            ...
            {/* Decorative divider */}
            <div className="sumi-divider-dark" style={{ width: "100%", marginBottom: 24 }} />
            ...
            <div className="fade-in-up fade-in-up-4" style={{ marginTop: 32 }}>
              ...
              <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
                {/* Primary - washi on sumi with accent */}
                <button
                  style={{
                    padding: "8px 20px",
                    borderRadius: 4,
